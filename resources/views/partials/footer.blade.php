...
<footer>
  <div class="footer-grid">
    ...
    <div class="fbrand">
      <a class="logo" href="{{ route('home') }}">
        ...
        <span class="logo-name" style="color:#fff">MESO<em style="color:var(--or)">TRAVO</em></span>
      </a>
      ...
      <div class="fsoc-row">
        ...
        <a class="fsoc" href="https://www.linkedin.com/company/mesotravocom" aria-label="LinkedIn">in</a>
      </div>
    </div>
  ...
  <div class="fbot">
    <span>© {{ date('Y') }} Mesotravo · Tous droits réservés</span>
