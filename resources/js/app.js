...
import AdminConfigurationComponent from "./components/back/admin/AdminConfigurationComponent.vue";
import AdminMailComponent from "./components/back/admin/AdminMailComponent.vue";
...
import ContractorObligationsComponent from "./components/back/contractor/ContractorObligationsComponent.vue";
...
app.component("admin-configuration-component", AdminConfigurationComponent);
app.component("admin-mail-component", AdminMailComponent);
...
app.component("contractor-obligations-component", ContractorObligationsComponent);
app.component(
    "contractor-accreditation-component",
    ContractorAccreditationComponent
);
app.component("messages-component", MessagesComponent);

const appRoot = document.getElementById("mesotravo-app");
if (appRoot) app.mount(appRoot);
initIconMode();
